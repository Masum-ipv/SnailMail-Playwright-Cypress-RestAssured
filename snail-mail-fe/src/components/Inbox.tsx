...
import { Compose } from "./Compose"; //Import the Compose component we created
...
export const Inbox: React.FC = () => {
  ...
  return (
    <div>
      ...
      {showCompose ? (
        <Compose data-testid="compose-component" onClose={toggleShowCompose} />
      ) : (
        <button
